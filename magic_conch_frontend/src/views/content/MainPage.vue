...
import SelfEvaluationPage from "@/views/content/selfEvaluation/SelfEvaluationPage.vue";
import ResourceCenterPage from "./resourceCenter/ResourceCenterPage.vue";
import ProfessionalHelpPage from "./professionalHelp/ProfessionalHelpPage.vue";
...
const selectComponent = (component: string) => {
  ...
  switch (component) {
    case 'SelfEvaluation':
      showComponent.value = SelfEvaluationPage
      break
    case 'ChatPage':
      showComponent.value = ChatPage
      break
    case 'ResourceCenter':
      showComponent.value = ResourceCenterPage
      break
    case 'ProfessionalHelp':
      showComponent.value = ProfessionalHelpPage
      break
  }
}
